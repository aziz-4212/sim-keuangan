    ...
    <header class="navbar navbar-expand-md sticky-top d-print-none">
        <div class="container-fluid">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <a href="{{ route('home') }}">
                    <span class="navbar-brand-text typing-text"></span>
                </a>
            </h1>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                        ...
                        <div class="d-none d-xl-block ps-2">
                            <div>{{ auth()->user()->user_log->USFULLNM }}</div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('laporan.index') }}" rel="noopener">
                                    Laporan Keuangan
                                </a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('jasaMedis') }}" rel="noopener">
                                    Jasa Medis Per Transaksi
                                </a>
                            </div>
                        </li>
                    </ul>
